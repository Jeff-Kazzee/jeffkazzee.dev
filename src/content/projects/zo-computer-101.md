...
screenshots:
  - src: ./_images/zo-computer-101.webp
...
The site is built to be searched, browsed by topic, and used without a login. It is the explainer layer: read a guide, copy a recipe, then go build inside your own Zo workspace.
