...
It's the system behind how I build: project state stays visible, decisions stay inspectable, and each session leaves the next one a usable starting point.
