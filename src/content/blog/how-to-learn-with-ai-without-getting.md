...
description: "A four-step workshop on using AI to build a skill instead of outsourcing the effort."
pubDate: 2026-05-26
canonicalUrl: https://jeffkazzee.substack.com/p/how-to-learn-with-ai-without-getting
tags: []
---
...
The four steps expose the moment where you stop thinking and ask the model to think for you. By the end you’ll have run them once on a skill you’ve been meaning to learn. Have a chat tab open as you read. Any of [Claude](https://claude.ai), [ChatGPT](https://chatgpt.com), or [Gemini](https://gemini.google.com) works. If you don’t have an account,[DeepSeek Chat](https://chat.deepseek.com), [Qwen Chat](https://chat.qwen.ai), [Z.ai Chat](https://chat.z.ai), and [Kimi Chat](https://kimi.com) are free without signup.
...
**Take the prompts with you.** All five prompts from this article, ready to paste into any chat: **[bit.ly/3RZIDTu](https://bit.ly/3RZIDTu)**
